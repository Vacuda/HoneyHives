...
public class SE_FlowerIndicator : MonoBehaviour
{
    ...
    public void Awake()
    {
        ColorChangerScript = gameObject.transform.parent.transform.parent.GetComponent<SE_WorldGrid>().ColorChangerScript;
