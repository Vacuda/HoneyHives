...
public class SE_VineValidator : MonoBehaviour
{

    GameObject honeycomb;
    SE_HoneyComb HoneyCombScript;

    Dictionary<wg_ADDRESS, SE_Piece> PieceRefDict = new Dictionary<wg_ADDRESS, SE_Piece>();

    void Start()
    {

        honeycomb = gameObject.transform.GetChild(0).gameObject;
        HoneyCombScript = honeycomb.GetComponent<SE_HoneyComb>();

        //convert dictionary to put to PieceScript
        foreach(var slot in HoneyCombScript.HoneySlotRefDict)
        {
            PieceRefDict.Add(slot.Key, slot.Value.transform.GetChild(0).GetComponent<SE_Piece>());
        }

        Debug.Log("copied slot ref dict: " + PieceRefDict.Count);


    }


    public void Validate_ThisHoneyComb()
    {
        ...
        for (int i = 1; i <= 9; i++)
        {
            ...
            //if flower is good
            if (Validate_ThisFlower(FlowerName))
            {
                //activate
                honeycomb.transform.Find(FlowerName).GetComponent<SE_FlowerIndicator>().Activate_Flower();
            ...
            {
                //deactivate
                honeycomb.transform.Find(FlowerName).GetComponent<SE_FlowerIndicator>().Deactivate_Flower();
            }
        }
        ...
        {
            //finalize honeycomb
            HoneyCombScript.Finalize_ThisHoneyComb();
        }
    }
    ...
    private bool Validate_ThisFlower(string flowername)
    {
        /*
        ...
        switch (flowername)
        {
            case "FlowerIndicator_1":
                {
                    fv_FACEVALUE val1 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val2 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_3);
                    fv_FACEVALUE val3 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val4 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_3);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            case "FlowerIndicator_2":
                {
                    fv_FACEVALUE val1 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val2 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_3);
                    fv_FACEVALUE val3 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val4 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_3);
                    fv_FACEVALUE val5 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_3);
                    fv_FACEVALUE val6 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_3);
                    return DoesThisValidate(val1, val2, val3, val4, val5, val6);
                }
            case "FlowerIndicator_3":
                {
                    fv_FACEVALUE val1 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val2 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_3);
                    fv_FACEVALUE val3 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_6);
                    fv_FACEVALUE val4 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_3);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            case "FlowerIndicator_4":
                {
                    fv_FACEVALUE val1 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val2 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_2);
                    fv_FACEVALUE val3 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val4 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_2);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            case "FlowerIndicator_5":
                {
                    fv_FACEVALUE val1 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val2 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_2);
                    fv_FACEVALUE val3 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val4 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_2);
                    fv_FACEVALUE val5 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val6 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_2);
                    return DoesThisValidate(val1, val2, val3, val4, val5, val6);
                }
            case "FlowerIndicator_6":
                {
                    fv_FACEVALUE val1 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val2 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_2);
                    fv_FACEVALUE val3 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_5);
                    fv_FACEVALUE val4 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_2);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            case "FlowerIndicator_7":
                {
                    fv_FACEVALUE val1 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val2 = PieceRefDict[BB].Get_FaceValue_WithOffset(TRI_1);
                    fv_FACEVALUE val3 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val4 = PieceRefDict[EE].Get_FaceValue_WithOffset(TRI_1);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            case "FlowerIndicator_8":
                {
                    fv_FACEVALUE val1 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val2 = PieceRefDict[AA].Get_FaceValue_WithOffset(TRI_1);
                    fv_FACEVALUE val3 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val4 = PieceRefDict[DD].Get_FaceValue_WithOffset(TRI_1);
                    fv_FACEVALUE val5 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val6 = PieceRefDict[GG].Get_FaceValue_WithOffset(TRI_1);
                    return DoesThisValidate(val1, val2, val3, val4, val5, val6);
                }
            case "FlowerIndicator_9":
                {
                    fv_FACEVALUE val1 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val2 = PieceRefDict[CC].Get_FaceValue_WithOffset(TRI_1);
                    fv_FACEVALUE val3 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_4);
                    fv_FACEVALUE val4 = PieceRefDict[FF].Get_FaceValue_WithOffset(TRI_1);
                    return DoesThisValidate(val1, val2, val3, val4);
                }
            default:
                return false;
    ...
    private bool Check_ForNulls(fv_FACEVALUE val1, fv_FACEVALUE val2, fv_FACEVALUE val3, fv_FACEVALUE val4, fv_FACEVALUE val5 = v_1, fv_FACEVALUE val6 = v_1)
    {
        if(val1 == v_null || val2 == v_null || val3 == v_null || val4 == v_null || val5 == v_null || val6 == v_null)
        {
            return true;
        }
